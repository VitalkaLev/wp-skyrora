...
Destination folder does not exist. Creating folder: [doc-root]/wp-content/webp-express/webp-images/themes/swipeks-theme/components/page/technology.list/preview

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/wp-content/themes/swipeks-theme/components/page/technology.list/preview/preview.jpg
- destination: [doc-root]/wp-content/webp-express/webp-images/themes/swipeks-theme/components/page/technology.list/preview/preview.jpg.webp
...
Converted image in 208 ms, reducing file size with 87% (went from 70 kb to 9 kb)
