WebP Express 0.19.1. Conversion triggered with the conversion script (wod/webp-on-demand.php), 2021-08-28 14:10:52
...
Destination folder does not exist. Creating folder: [doc-root]/wp-content/webp-express/webp-images/themes/swipeks-theme/components/page/button/preview

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/wp-content/themes/swipeks-theme/components/page/button/preview/preview.jpg
- destination: [doc-root]/wp-content/webp-express/webp-images/themes/swipeks-theme/components/page/button/preview/preview.jpg.webp
...
Converted image in 194 ms, reducing file size with 92% (went from 19 kb to 1 kb)
