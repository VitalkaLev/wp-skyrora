WebP Express 0.19.1. Conversion triggered with the conversion script (wod/webp-on-demand.php), 2021-08-16 13:42:24
...
Destination folder does not exist. Creating folder: [doc-root]/wp-content/webp-express/webp-images/themes/swipeks-theme/components/page/table/preview

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/wp-content/themes/swipeks-theme/components/page/table/preview/two-column.jpg
- destination: [doc-root]/wp-content/webp-express/webp-images/themes/swipeks-theme/components/page/table/preview/two-column.jpg.webp
...
Converted image in 214 ms, reducing file size with 88% (went from 39 kb to 5 kb)
