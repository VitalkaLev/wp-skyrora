                ...
                <div class="col-md-12">   
                    <a href="javascript: void(0)" rel="nofollow" class="product--horizontal product--column-mobile product--large-picture product">
                        ...
                        <div class="product__picture">
                            <picture>
                                <source media="(min-width: 769px)" srcset="<?php echo get_the_post_thumbnail_url($pad->ID,array( 178, 274 ) ); ?>"/>
                                <source srcset="<?php echo get_the_post_thumbnail_url($pad->ID,array( 178, 274 )); ?>" type="image/webp" />
