	...
	if ( is_home() || is_front_page() ) {
		...
		if ( is_category() ) {
			...
			if ( get_query_var( 'paged' ) ) {
				...
				if ( $show_current ) {
					if ( $position >= 1 ) echo $sep;
					echo '<li><a href=" '. HOME.'/blog">Media</a><svg width="1em" height="1em" class="icon icon-arrow-right ">
				<use xlink:href="/wp-content/themes/skyrora-theme/dist/s/images/useful/svg/theme/symbol-defs.svg#icon-arrow-right"></use>
			  </svg></li>';
			...
			if ( get_post_type() != 'post' ) {
				...
				foreach ( $parents as $cat ) {
					$position += 1;
					if ( $position > 1 ) echo $sep;
					echo '<li><a href=" '. HOME.'/blog"><span>Media</sapn></a><svg width="1em" height="1em" class="icon icon-arrow-right ">
				<use xlink:href="/wp-content/themes/skyrora-theme/dist/s/images/useful/svg/theme/symbol-defs.svg#icon-arrow-right"></use>
			  </svg></li>';
					echo sprintf( $link, get_category_link( $cat ), get_cat_name( $cat ), $position );
				}
